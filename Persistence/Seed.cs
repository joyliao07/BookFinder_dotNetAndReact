        ...
        public static async Task SeedData(DataContext context, UserManager<User> userManager)
        {
            if (!userManager.Users.Any())
            {
                List<User> users = new List<User>
                {
                    ...
                    new User {DisplayName="Amy", UserName="amy", Email="amy@test.com"},
                    new User {DisplayName="Katie", UserName="katie", Email="katie@test.com"},
                    new User {DisplayName="Joyce", UserName="joyce", Email="joyce@test.com"}
                };
